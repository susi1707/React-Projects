...
export default function AdminView({ adminUserData }) {
    ...
    return (
        <div>
                            ...
                            currentPosts.map((admin) => (
                                <tr key={admin.adminId}>
                                    ...
                                    <td><label class="switch">
                                        <input type="checkbox" checked={admin.activate  === "true"}/>
            ...
            <DeleteAlert isOpen={isAddUserModalOpen} onClose={() => setIsAddUserModalOpen(false)} deleteId={adminId} />
            <AdminEditUser isOpen={isEditModalOpen} onClose={() => setisEditModalOpen(false)} data={updateAdmin} />
        </div>
